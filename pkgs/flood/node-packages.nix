...
let
  sources = {
    ...
    "geoip-country-4.0.103" = {
      name = "geoip-country";
      packageName = "geoip-country";
      version = "4.0.103";
      src = fetchurl {
        url = "https://registry.npmjs.org/geoip-country/-/geoip-country-4.0.103.tgz";
        sha512 = "NJvM8kG7Nh5a8NlezNZfxoJ1d4TeP2ALJa3Qf129Sq1gQOs98b0eoRaG30QJTulNB03VsG0VzrXWMSRuGNgapg==";
      };
    };
    "glob-7.2.0" = {
      name = "glob";
